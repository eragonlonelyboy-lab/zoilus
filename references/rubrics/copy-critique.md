...
## Required output
- **"the hook that worked"**: the one moment, if any, that actually earned attention, and why it worked. If nothing did, say nothing did. This is what tells the writer which instinct to keep, and it is what proves the critic is reading rather than reflexively slashing.
- **"quote the actual words"** of the copy when naming a finding, never paraphrase. A paraphrased complaint cannot be acted on and cannot be checked.

## Quality checks
- The opening earns the next three seconds; front-loads the point, no wind-up.
- One clear reader, one desired action, no vague "let me know."
- Specific over abstract: numbers, concrete nouns, the reader's own words.
- The one highest-leverage fix, the single change that would win the reader back, is named.

## Verdict
FAIL if the reader drops off early, the copy is generic-anywhere, or the highest-leverage fix is unnamed. Otherwise mark the dead weight, the eye-rolls, the hook that worked, and the one fix that matters most. Do not soften it into a feedback sandwich, and do not be encouraging to spare the writer's feelings.
